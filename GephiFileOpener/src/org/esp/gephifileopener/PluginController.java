...
public class PluginController implements Tool {
    ...
    private PanelsTopComponent ectc;
    ...
    private PanelsTopComponent findInstance(){
        return (PanelsTopComponent) WindowManager.getDefault().findTopComponent("editCPPTopComponent");
    }
    ...
    public ToolUI getUI() {
        return new ToolUI() {
            ...
            public String getName() {
                return NbBundle.getMessage(PanelsTopComponent.class, "OpenIDE-Module-Name");
            }

            @Override
            public String getDescription() {
                return NbBundle.getMessage(PanelsTopComponent.class, "OpenIDE-Module-Short-Description");
            }
